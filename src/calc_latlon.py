...
if __name__ == "__main__":
    ...
    #calc_moving(45, 135,120,steps[0])
    START = {'longitude': -157.85059440538518, 'latitude': 21.292003771901275}
    GOAL = {'longitude': -157.84389066977633, 'latitude': 21.289743961838436}
    print(calc_theta(START, GOAL))
